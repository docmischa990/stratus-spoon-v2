...
export function RecipeLikeDislike({ recipe }) {
  ...
  const { data: currentRating = null } = useRating(recipe.id)
  ...
  const isDisliked = currentRating === 'dislike'
  ...
  return (
    <div className="flex items-center gap-3">
      ...
      <button
        ...
        aria-label={isLiked ? 'Remove like' : 'Like this recipe'}
      ...
      <button
        ...
        className={`flex items-center gap-1.5 rounded-full px-3 py-1.5 text-sm font-medium transition-colors
          ...
          disabled:cursor-not-allowed disabled:opacity-50`}
        aria-label={isDisliked ? 'Remove dislike' : 'Dislike this recipe'}
