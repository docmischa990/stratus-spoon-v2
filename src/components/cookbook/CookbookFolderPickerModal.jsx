...
export function CookbookFolderPickerModal({ isOpen, onClose, recipe }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-primary-dark/45 px-4 py-6">
      <div className="card-base max-h-[85vh] w-full max-w-2xl overflow-y-auto p-6">
